 ...
 *               $ref: '#/components/schemas/StandardResponse'
 */
router.post('/invoices', requirePermission(PERMISSIONS.INVOICE_CREATE), validateRequest(createInvoiceSchema), controller.createInvoice);
...
router.delete('/invoices/:id', requirePermission(PERMISSIONS.INVOICE_DELETE), validateRequest(invoiceIdParamSchema), controller.deleteInvoice);

router.post('/payments', requirePermission(PERMISSIONS.PAYMENT_CREATE), validateRequest(createPaymentSchema), controller.createPayment);
