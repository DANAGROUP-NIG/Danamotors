 ...
 */
router.get('/',      requirePermission(PERMISSIONS.ENQUIRY_READ),   validateRequest(listEnquiriesQuerySchema), controller.listEnquiries);
 ...
 *         $ref: '#/components/schemas/ErrorResponse'
 */
router.get('/:id/prefill', requirePermission(PERMISSIONS.ENQUIRY_READ), validateRequest(enquiryIdParamSchema), controller.prefillFromEnquiry);
 ...
 *         $ref: '#/components/schemas/ErrorResponse'
 */
router.get('/:id',   requirePermission(PERMISSIONS.ENQUIRY_READ),   validateRequest(enquiryIdParamSchema), controller.getEnquiry);
 ...
 *         $ref: '#/components/schemas/ErrorResponse'
 */
router.patch('/:id/review', requirePermission(PERMISSIONS.ENQUIRY_UPDATE), validateRequest(reviewEnquirySchema), controller.reviewEnquiry);
 ...
 *         $ref: '#/components/schemas/ErrorResponse'
 */
router.delete('/:id', requirePermission(PERMISSIONS.ENQUIRY_DELETE), validateRequest(enquiryIdParamSchema), controller.deleteEnquiry);
