...
export function TechniciansPage() {
  return (
    <div className="flex flex-col gap-5 p-4 lg:p-6">
      <PageHeader
        title="Technicians"
        description="Workshop staff and technician assignments."
      />
      <PlaceholderTable columns={["Name", "Specialisation", "Active Jobs", "Joined"]}
        message="No technicians yet. They will appear here once the workshop module is wired." />
    </div>
  );
}
