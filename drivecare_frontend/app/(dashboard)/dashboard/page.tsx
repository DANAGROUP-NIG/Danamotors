...
export default function DashboardPage() {
  const { user, hasAccess, isSuperAdmin, isManagerOrAbove, isReceptionist } = useAuth();
      ...
      <div className="flex flex-col gap-6 p-4 lg:p-6">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            {canCreateJob && (
              <button
                onClick={() => setShowNewJobCard(true)}
          ...
          <div className="flex items-center gap-3 rounded-xl border border-amber-200 bg-amber-50 px-4 py-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-amber-700">
                Items at or below reorder level — review before next service
                day.
              </p>
            </div>
            <a
              href="/inventory"
              className="shrink-0 text-xs font-bold text-amber-700 hover:underline"
            >
              View low stock items →
            </a>
          </div>
